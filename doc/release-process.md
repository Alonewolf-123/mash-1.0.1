...
###Build Mash Core for Linux, Windows, and OS X:
...
- Update bitcoin.org version
  ...
  - First, check to see if the Mash.org maintainers have prepared a
  ...
  - If they have not prepared a release, follow the Mash.org release
...
- Announce the release:
  ...
  - Mash-development mailing list

  - Update title of #bitcoin on Freenode IRC

  - Optionally reddit /r/Mash, ... but this will usually sort out itself
