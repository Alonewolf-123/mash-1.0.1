...
#define SPORK_8_MASTERNODE_PAYMENT_ENFORCEMENT_DEFAULT 978307200//4070908800 //OFF
#define SPORK_9_MASTERNODE_BUDGET_ENFORCEMENT_DEFAULT 978307200//4070908800  //OFF
#define SPORK_10_MASTERNODE_PAY_UPDATED_NODES_DEFAULT 978307200//4070908800  //OFF
#define SPORK_11_RESET_BUDGET_DEFAULT 0
#define SPORK_12_RECONSIDER_BLOCKS_DEFAULT 0
#define SPORK_13_ENABLE_SUPERBLOCKS_DEFAULT 1525086972		//4070908800            //OFF
#define SPORK_14_NEW_PROTOCOL_ENFORCEMENT_DEFAULT 978307200//4070908800      //OFF
...
public:
    ...
    uint256 GetHash()
    {
        uint256 n = HashMash(BEGIN(nSporkID), END(nTimeSigned));
        return n;
    }
